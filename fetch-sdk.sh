...
$WGET "https://dl.google.com/android/repository/commandlinetools-$OS_NAME-9477386_latest.zip" || exit 1
mkdir -p cmdline-tools || exit 1
unzip -qq "commandlinetools-$OS_NAME-9477386_latest.zip" -d cmdline-tools || exit 1
rm "commandlinetools-$OS_NAME-9477386_latest.zip" || exit 1
